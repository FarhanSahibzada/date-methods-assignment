...
document.getElementById("demo2").innerHTML = "Current Month is :" +arr[date1.getMonth()]+"<hr>" ;



                                  //task3
 let date2 = new Date().toDateString();
 document.getElementById("demo3").innerHTML = "Today is :"+ date2.slice(0 ,4) +"<hr>";
...
if (arr2[date3] === "Sat" || arr2[date3] === "Sun"){
    document.getElementById("demo4").innerHTML = "Today is :"+ "it's Fun Day <hr>";
}else{
    document.getElementById("demo4").innerHTML = "Today is :"+ "it's a Noraml Day <hr>";
}      
...
if (date4 <= 15){
    document.getElementById("demo5").innerHTML = "First fifteen days of the month <hr>";
}else{
    document.getElementById("demo5").innerHTML = "Last fifteen days of the month <hr>";
}
...
document.getElementById("demo7").innerHTML = "Elapsed milliseconds since jan 1 1970 : "+ date5;  
let sec = Math.floor(date5 /1000 )
let min = Math.floor(sec/ 60)
document.getElementById("demo8").innerHTML = "Elapsed Minutes since jan 1 1970 : "+ min +"<hr>";
...
document.getElementById("demo10").innerHTML = "Later Date :" + laterDate +"<hr>";
...
document.getElementById("demo11").innerHTML = day +" Days Have Passed Since 1 Ramadan of 2024 <hr>";
...
document.getElementById("demo13").innerHTML = sec2 + " Seconds had passed since begginning of the year <hr>";
...
document.getElementById("demo15").innerHTML = "1 hour ago :"+ currentDate +"<hr>" ;
...
document.getElementById("demo17").innerHTML = "100 year ago :"+ currentDates +"<hr>" ;                             
